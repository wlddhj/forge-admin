      ...
      new hiprint.PrintElementTypeGroup("表格/其他", [
        {
          ...
          footerFormatter: function (options, rows, data, currentPageGridRowsData) {
            ...
            if (data && data["totalAmountUpcase"]) {
              return `<td style="padding:0 20px" colspan="100">${"金额大写：" + data["totalAmountUpcase"]}</td>`;
            }
            return '<td style="padding:0 20px" colspan="100">金额大写：</td>';
          },
        },
